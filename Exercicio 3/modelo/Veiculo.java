...
public class Veiculo {
	...
	public Veiculo(String placa, String marca, String modelo, int ano, int kmInicial, int kmFinal, double valorLocacao,
			String chassi, Pessoa dono, double valorKmRodado) {
		this.placa = placa;
		this.marca = marca;
		this.modelo = modelo;
		this.ano = ano;
		...
		this.calculalValorLocacao();
	}

	public void calculalValorLocacao() {
	...
	public String toString() {
		return "Veiculo[placa=" + placa + ", marca=" + marca + ", modelo=" + modelo + ", ano=" + ano
				...
				+ ", valorLocacao=" + valorLocacao + ", chassi=" + chassi + ", proprietario=" + dono + "]";
	}
}